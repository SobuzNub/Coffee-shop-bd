  ...
  return (
    <>
      ...
      <div className='bg-gray-100 text-gray-800 flex justify-between md:hidden'>
        <div>
          <div className='block cursor-pointer p-4 font-bold'>
            <Link to='/'>
              <p className='text-3xl'>Coffee Shop</p>
            </Link>
          </div>
        </div>
      ...
      >
        <div>
          <div>
            <div className='w-full hidden md:flex px-4 py-2 shadow-lg rounded-lg justify-center items-center bg-[#D2B48C] mx-auto'>
              <Link to='/'>
                <p className='text-3xl font-bold'>Coffee Shop</p>
              </Link>
            </div>
          </div>
